...
class_name DictionaryDownloader

var template_id: String
var file_sub_path: String


func _init(base_path, template_id, file_sub_path: String, headers: Array) -> void:
...
func get_url() -> String:
	return "%s/v1/api/dictionaries/%s" % [self.base_path, self.file_sub_path]


func do_redirect_request(redirect_url, export_path: String) -> void:
	var file_name = "%s.json" % self.template_id
